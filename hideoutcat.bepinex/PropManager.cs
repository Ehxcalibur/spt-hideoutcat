    ...
    internal static class PropManager
    {
        ...
        static void LoadProps()
        {
            ...
            if (kitchenArea != null)
            {
                if (herring == null)
                {
                    var propsBundle = AssetBundleLoader.LoadAssetBundle("hideoutcat_props");
                    if (propsBundle != null)
                    {
                        var herringPrefab = propsBundle.LoadAsset<GameObject>("herring_opened");
                        if (herringPrefab != null)
                        {
                            herring = GameObject.Instantiate(herringPrefab);
